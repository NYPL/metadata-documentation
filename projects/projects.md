...
### Digital Asset Infrastructure Renewal (DAIS)

| Dates | beginning December 2024 |
| Metadata Services Members | Karly W.
...
- SCP and Metadata Services are working to create catalog records for objects held by the Schomburg Art and Artifacts Division including Artifacts, Buttons, Calendars, Drawings, Medals, Paintings, Portfolios, Postcards, Posters, Prints, Sculptures, and Textiles
- Metadata Services is editing, updating, and standardizing the metadata, including locating the Library of Congress Name Authorities for applicable names and corporations and determining mapping between this metadata and MARC fields
- Metadata Services and BookOps are creating a Constant Data to create MARC records in OCLC Connexion from the updated metadata
...
- When COVID-19 required staff to work from home in 2020, Metadata Services was tasked with generating metadata projects suitable for library staff to work on remotely to assist with metadata quality efforts
...
- Since August 2021, the project has been fully taken over by Metadata Services staff
...
- Beginning in June 2020, Metadata Services started its collaboration with the Theatre Division to programmatically batch update MMS records with these new titles
- Beginning August 2020, Metadata Services also started adding [Name Subjects](/metadata-documentation/metadata/element/subject/#name) to records based on the names present in the new titles
- As a result of incorporating Name Subject additions to the project workflow, Metadata Services created an internal "name thesaurus" to both organize name authority research and assist with batch programmatic updates
...
| Metadata Services Members | Emma C., Karly W., Sarah A.
| Non-Metadata Services Members | Bob K. (Music Division), David L. (Photography Collection), Samie K. (Art & Architecture Collection), Gina M. (Copyright and Information Policy), Angela R. (Dance Division) |
...
- Metadata Services leads the NYPL Wikidata Working Group, which began meeting monthly in July 2023
...
- Metadata Services developed a new workflow with the ILS Team to systematically add and maintain links from the [Library catalog](https://www.nypl.org/research/research-catalog/) to corresponding digitized materials
...
- Through a combination of newly automated processes and manual review of discrepancies, Metadata Services was able to nearly double the number of records in the catalog that displayed active links to DC to 33,401 records with our initial refresh in September 2022
- Metadata Services was also able to improve the quantity and quality of links from DC to the catalog and standardize previously-inconsistent link labels as they appear in the library catalog
- Metadata Services is continuing to refine our workflow with the goal of supplying refreshed data to the Library's ILS Team on a regular basis so they can perform batch updates
...
- Many [Subject](/metadata-documentation/metadata/element/subject/) element terms in MMS records do not match terms in Metadata Services's preferred [controlled vocabularies](/metadata-documentation/metadata/guidelines/#controlled-vocabularies)
...
- To address these outdated terms, Metadata Services is developing a workflow to systematically and programmatically update [Subject](/metadata-documentation/metadata/element/subject/) elements in MMS records on a regular basis, starting with LCSH terms using the [Library of Congress Bulk Export of Library of Congress Subject Headings](https://id.loc.gov/authorities/subjects.html#:~:text=SKOS%20%2D%20JSON-,Bulk%20Download,-Bulk%20exports%20%2D%20MADS)
- This project was initiated following the March 2023 Library of Congress revision of the term "Slaves" to "[Enslaved persons](http://id.loc.gov/authorities/subjects/sh85123347)," which prompted Metadata Services to update [this term and other related terms](https://docs.google.com/spreadsheets/d/1OqTynL9Y5fe8o6VfmCh9MKR97zsF0Kr-FLvfdvD9LlI/edit#gid=1491352248), affecting 873 approved records and 763 draft records in MMS
...
- Metadata Services is committed to integrating inclusive and reparative description into our everyday work and has led several efforts to address harmful description and content on NYPL Digital Collections
- Informed by Metadata Services staff's participation in professional development and the Library's [DEIA in Collections: Collections Access Working Group](#deia-in-collections-collections-access-working-group), Metadata Services maintains internal guidelines and workflows, which can be found at [MMS › Metadata › Inclusive & Reparative Description](/metadata-documentation/metadata/inclusive-reparative/)
- Metadata Services is developing ideas for specific holistic remediation projects to align extant legacy description with updated guidelines
...
| Metadata Services Members | Molly O.
...
- The former Manager, Metadata Services served as a chair of the [Collections Access Working Group](https://lair.nypl.org/-/departments/internal-affairs/human-resources/diversity-equity-inclusion-access-at-nypl/deia-in-collections), which evolved out of the DEIA in Collections working group initiated in 2021
