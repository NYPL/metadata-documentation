...
1. Review the task description to determine what item(s) need to be created in MMS
    1. Search MMS to verify whether an earlier record for the item(s) (or any parent collections or containers) already exist(s)
    1. If a [bnumber](/metadata-documentation/metadata/element/identifier/bnumber/), [MSS Unit ID](/metadata-documentation/metadata/element/identifier/mss-unit/), or [TMS ID](/metadata-documentation/metadata/element/identifier/tms/#tms-id) has been provided, begin by searching it
