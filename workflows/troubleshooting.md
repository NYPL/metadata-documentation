...
1. Add a comment with the tag `@msu-archives-portal`, who will:
...
1. In the relevant ClickUp task generated by a contact form submission, add a comment with the tag `@msu-sierra`
